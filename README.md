...
<p align="center">
  ...
  <i>Building intelligent systems with LLMs, RAG pipelines, and Deep Learning</i>
</p>
...
- 📫 Reach me: **info.sangamgupta@gmail.com** · **+91 9628918995**

---

## 🚀 Featured Projects

### 🌿 [PlantCareAI — AI Plant Disease Detection & Assistant](https://github.com/sangam962895/-AI-Plant-Disease-Detection)
> AI-powered web app that detects 40+ plant diseases from leaf images and provides treatment guidance via an intelligent chatbot.

- Built a **Transfer Learning CNN** (TensorFlow/Keras) achieving **95%+ accuracy** across 10 crop types in under 1 second
- Designed full inference pipeline: image upload → preprocessing (224×224px) → CNN prediction → treatment generation
- Integrated **Google Gemini Pro** chatbot with session-based diagnosis context for personalized agricultural Q&A
- Deployed a responsive **Flask + Bootstrap** web app with drag-and-drop upload and diagnosis history tracking

`Python` `Flask` `TensorFlow` `Transfer Learning` `Google Gemini Pro` `Bootstrap` `Pillow` `NumPy`
