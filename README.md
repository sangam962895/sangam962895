...
Email Me 👉 ✉️ **info.sangamgupta@gmail.com** For Collaboration/Project or Anything Else. 😊😊
...
## 🧠 AI & Generative AI Knowledge

* Large Language Models (LLM) fundamentals
* Retrieval Augmented Generation (RAG)
* Prompt Engineering basics
* Vector databases and embeddings (FAISS understanding)
* Using model APIs (OpenAI / HuggingFace)

## 🐳 Dev & Deployment

* Docker (containerization basics and environment setup)
